<!-- Footer -->
    <footer class="bg-yellow-custom px-6 py-12" id="footer">
        <div class="max-w-7xl mx-auto text-center">
            ...
            <div class="flex flex-col space-y-2 sm:flex-row sm:justify-center sm:space-x-8">
                <a href="#" class="text-black hover:text-gray-700 underline font-medium transition-colors">
                    POLITIQUE CONFIDENTIALE →
                </a>
            </div>
            <div class="mt-8 flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-x-6">
