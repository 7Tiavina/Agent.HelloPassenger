...
window.modalResolve;
window.wasQuickDateModalOpen = false;
 ...
 */
window.hideQuickDateModalIfOpen = function() {
 ...
 */
window.showCustomPrompt = function(title, message, label) {
    hideQuickDateModalIfOpen();
    const modalOverlay = document.getElementById('custom-modal-overlay');
 ...
 */
window.showLoginOrGuestPrompt = function() {
    hideQuickDateModalIfOpen();
    const modalOverlay = document.getElementById('custom-modal-overlay');
    if (!modalOverlay) return Promise.resolve(null);
 ...
 */
window.setupGlobalModalListeners = function() {
    const modalOverlay = document.getElementById('custom-modal-overlay');
...
window.displayOptions = function(dureeEnMinutes) {
...
window.updateAdvertModalButtons = function() {
...
window.toggleOptionFromModal = function(optionKey) {
...
window.showOptionsAdvertisementModal = function() {
    return new Promise(resolve => {
