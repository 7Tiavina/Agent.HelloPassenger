window.qdm_temp_depot_date;
window.qdm_temp_retrait_date;
window.qdm_editing_mode = 'depot';
window.qdm_depot_day_selection = 'custom';
window.qdm_retrait_day_selection = 'custom';

window.openQuickDateModal = function() {
...
window.updateQdmDisplay = function() {
...
window.generateHourButtons = function(date) {
    const hourGrid = document.getElementById('qdm-hour-grid');
    hourGrid.innerHTML = '';
...
window.setupQdmListeners = function() {
