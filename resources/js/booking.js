...
window.isPriorityAvailable = false;
window.isPremiumAvailable = false;


/**
 * Affiche les dates sélectionnées dans la section de résumé.
 */
window.displaySelectedDates = function() {
 ...
 */
window.checkSingleDateAvailability = async function(date, time) {
 ...
 */
window.getQuoteAndDisplay = async function() {
 ...
 */
window.handleTotalClick = async function() {
 ...
 */
window.applyDateInputConstraints = function() {
